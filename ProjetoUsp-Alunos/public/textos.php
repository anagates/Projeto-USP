...
<head>
    <meta charset="utf-8">
    <title>Textos do Ecoar - USP</title>
...
<body>
    ...
    <div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center">
            <h1 class="display-4 text-white animated slideInDown mb-4">Textos Ecoar</h1>
        </div>
    </div>
...
<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    <h5 class="card-title">Relatos afetivos: da escuta à escrita, da escrita à escuta</h5>
    <p class="card-text">Valéria Bonafé; Lilian Campesato</p>
  </div>
  <ul class="list-group list-group-flush">
    <li class="list-group-item">In: Culturas Sonoras</li>
    <li class="list-group-item">Org: Fenando Iazzetta</li>
    <li class="list-group-item">Ed. Berro - Músicas e Sons</li>
    <li class="list-group-item">2025</li>
  </ul>
  <div class="card-body">
    <a href="https://berro.eca.usp.br/" class="card-link">Saiba Mais</a>
  </div>
</div>
<!-- fim do card -->
